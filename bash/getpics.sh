...
EOF
# retrieve and install the files kept in the https://zonzorp.net/pics.tgz 
wget -q -O ~/COMP2101/bash/pics.tgz https://zonzorp.net/pics.tgz && tar -xvf ~/COMP2101/bash/pics.tgz && rm ~/COMP2101/bash/pics.tgz && echo "tar file extraction successful local file removed"  
test -d ~/COMP2101/bash/pics.tgz 
